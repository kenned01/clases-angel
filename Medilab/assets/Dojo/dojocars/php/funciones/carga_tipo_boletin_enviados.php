...
if ($boletin==1) {
						...
						<tbody>
...

								{
									...
									<td> 
										...
										<center>
										 <a id="boton_generico" href="tu_perfil.php?op=documentos_enviados_2&id_usuario=<?php echo $id_cliente ?>&tipo_mensaje=1">Ver  Mensajes</a>  
										</center>
	...
	<center>
		...
		<input type="submit" id="boton_generico" value="Ver Resultados">
