...
?> 
		...
		<select style="background:#fff; font-size:1.2rem; font-family:Raleway" required name="ciudad_id" id="ciudad_id" onchange="cargar_buscador3_servicio(this.value)">
		...
		<div id="div_buscador3_servicio" style="display: inline-block; float:right" > 