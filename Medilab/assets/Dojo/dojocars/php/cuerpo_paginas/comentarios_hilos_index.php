...
#////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 ?>
  ...
  &nbsp;&nbsp;&nbsp; <a id="boton_generico" href="index.php?menu=foro_index&id_foro=<?php echo utf8_encode($id_foro) ?>&id_hilo=<?php echo utf8_encode($id_hilo) ?>&status=<?php echo utf8_encode($status)?>" style="text-decoration: none;float: left;" >< Return</a> <br><br>
...
if (!isset($_SESSION["contrasena"]))
  ...
  <h1>Debe<a href="index.php?menu=inscribete_iniciar">Iniciar sesion</a> para comentar en el foro</a></h1>
...
</b></b></li></ul></div></center></h3></div></div>